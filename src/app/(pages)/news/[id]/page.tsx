...
import { SvgBookmarkIcon, SvgShareIcon, SvgUserIcon } from '..//..//..//svg/svgs'
...
export default function Page({ params }: { params: { id: string } }) {
  ...
  // If we didn't find a matching page, return an error message
  if (!page) {
    return <IndexLayout>
            ...
            <div className='flex flex-col lg:flex-row gap-10'>
              ...
              <div className='flex flex-col gap-10 w-full lg:w-2/5'>
                <CardBlog
                  ...
                  image={pages[0].image} url={pages[0].url} />

                <CardBlog
                  title={pages[1].title}
                  description={pages[1].description}
                  image={pages[1].image} url={pages[1].url} />

                <CardBlog
                  title={pages[2].title}
                  description={pages[2].description}
                  image={pages[2].image} url={pages[2].url} />
              </div>
            </div>
          </div>
        </div>

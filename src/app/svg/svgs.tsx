...
export const SvgHamburguerIcon = ({ size, color }: Icon) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const SvgCloseIcon = ({ size }: Icon) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const SvgPlayIcon = ({ size, color }: Icon) => (
    <svg width={size} height={size} viewBox="-0.5 0 7 7" version="1.1" xmlns="http://www.w3.org/2000/svg" fill={color}><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>play [#ffffff]</title> <desc>Created with Sketch.</desc> <defs> </defs> <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"> <g id="Dribbble-Light-Preview" transform="translate(-347.000000, -3766.000000)" fill={color}> <g id="icons" transform="translate(56.000000, 160.000000)"> <path d="M296.494737,3608.57322 L292.500752,3606.14219 C291.83208,3605.73542 291,3606.25002 291,3607.06891 L291,3611.93095 C291,3612.7509 291.83208,3613.26444 292.500752,3612.85767 L296.494737,3610.42771 C297.168421,3610.01774 297.168421,3608.98319 296.494737,3608.57322"> </path> </g> </g> </g> </g></svg>
)

export const SvgPauseIcon = ({ size, color }: Icon) => (
    <svg width={size} height={size} viewBox="-1 0 8 8" version="1.1" xmlns="http://www.w3.org/2000/svg" fill={color}><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>pause [#ffffff]</title> <desc>Created with Sketch.</desc> <defs> </defs> <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"> <g id="Dribbble-Light-Preview" transform="translate(-227.000000, -3765.000000)" fill={color}> <g id="icons" transform="translate(56.000000, 160.000000)"> <path d="M172,3605 C171.448,3605 171,3605.448 171,3606 L171,3612 C171,3612.552 171.448,3613 172,3613 C172.552,3613 173,3612.552 173,3612 L173,3606 C173,3605.448 172.552,3605 172,3605 M177,3606 L177,3612 C177,3612.552 176.552,3613 176,3613 C175.448,3613 175,3612.552 175,3612 L175,3606 C175,3605.448 175.448,3605 176,3605 C176.552,3605 177,3605.448 177,3606"> </path> </g> </g> </g> </g></svg>
)


export const SvgSoundIcon = ({ size, color }: Icon) => (
    <svg width={size} height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill={color}><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M18.36,19.36a1,1,0,0,1-.7-.29,1,1,0,0,1,0-1.41,8,8,0,0,0,0-11.32,1,1,0,0,1,1.41-1.41,10,10,0,0,1,0,14.14A1,1,0,0,1,18.36,19.36Z"></path><path d="M15.54,16.54a1,1,0,0,1-.71-.3,1,1,0,0,1,0-1.41,4,4,0,0,0,0-5.66,1,1,0,0,1,1.41-1.41,6,6,0,0,1,0,8.48A1,1,0,0,1,15.54,16.54Z"></path><path d="M11.38,4.08a1,1,0,0,0-1.09.21L6.59,8H4a2,2,0,0,0-2,2v4a2,2,0,0,0,2,2H6.59l3.7,3.71A1,1,0,0,0,11,20a.84.84,0,0,0,.38-.08A1,1,0,0,0,12,19V5A1,1,0,0,0,11.38,4.08Z"></path></g></svg>
)

export const SvgMutedIcon = ({ size, color }: Icon) => (
...
export const SvgArrowIcon = ({ size, color }: Icon) => (
    <svg width={size} height={size} viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" fill={color}><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path fill={color} d="M338.752 104.704a64 64 0 0 0 0 90.496l316.8 316.8-316.8 316.8a64 64 0 0 0 90.496 90.496l362.048-362.048a64 64 0 0 0 0-90.496L429.248 104.704a64 64 0 0 0-90.496 0z"></path></g></svg>
)

export const SvgComputerIcon = ({ size, color }: Icon) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 62 47"
...
export const SvgPaintIcon = ({ size, color }: Icon) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 47 47"
...
export const SvgScuaresIcon = ({ size, color }: Icon) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 47 47"
...
export const SvgPictureIcon = ({ size, color }: Icon) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 57 47"
...
export const SvgUserIcon = ({ size }: Icon) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" stroke="#CCCCCC" strokeWidth="0.672"></g><g id="SVGRepo_iconCarrier"> <path d="M5 21C5 17.134 8.13401 14 12 14C15.866 14 19 17.134 19 21M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path> </g></svg>
)

export const SvgShareIcon = ({ size }: Icon) => (
    <svg width={size} height={size} viewBox="-1 0 26 26" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>share</title> <desc>Created with Sketch Beta.</desc> <defs> </defs> <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"> <g id="Icon-Set-Filled" transform="translate(-314.000000, -728.000000)" fill="#ffffff"> <path d="M333,744 C331.23,744 329.685,744.925 328.796,746.312 L323.441,743.252 C323.787,742.572 324,741.814 324,741 C324,740.497 323.903,740.021 323.765,739.563 L329.336,736.38 C330.249,737.37 331.547,738 333,738 C335.762,738 338,735.762 338,733 C338,730.238 335.762,728 333,728 C330.238,728 328,730.238 328,733 C328,733.503 328.097,733.979 328.235,734.438 L322.664,737.62 C321.751,736.631 320.453,736 319,736 C316.238,736 314,738.238 314,741 C314,743.762 316.238,746 319,746 C320.14,746 321.179,745.604 322.02,744.962 L328.055,748.46 C328.035,748.64 328,748.814 328,749 C328,751.762 330.238,754 333,754 C335.762,754 338,751.762 338,749 C338,746.238 335.762,744 333,744" id="share"> </path> </g> </g> </g></svg>
)

export const SvgBookmarkIcon = ({ size }: Icon) => (
    <svg width={size} height={size} viewBox="-4 0 30 30" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>bookmark</title> <desc>Created with Sketch Beta.</desc> <defs> </defs> <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"> <g id="Icon-Set-Filled" transform="translate(-419.000000, -153.000000)" fill="#ffffff"> <path d="M437,153 L423,153 C420.791,153 419,154.791 419,157 L419,179 C419,181.209 420.791,183 423,183 L430,176 L437,183 C439.209,183 441,181.209 441,179 L441,157 C441,154.791 439.209,153 437,153" id="bookmark"> </path> </g> </g> </g></svg>
)

export const SvgLoadIcon = ({ size }: Icon) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-loader-circle"><path d="M21 12a9 9 0 1 1-6.219-8.56" /></svg>
)

export const SvgCheckIcon = ({ size }: Icon) => (
...
export const SvgLogoPdt = ({ size = 24, color = "#ffffff" }: Icon) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 791.79 343.2"
        width={size}
        height={size}
    >
        <g>
            <path
                fill="#f41936"
                d="M332.62,195.46c-12.46,37.33-40.98,63.17-60.03,49.77v24.46c11.38-1.13,24.37-5.36,35.48-16.54,4.1-5.26,8.35-11.11,12.34-17.26h0c8.02-12.39,14.93-26.02,17.17-38.61,7.01-23.71,1.2-46.39,1.2-46.39.69,21.27-3.08,36.46-5.93,44.72-.09-.04-.17-.07-.26-.11Z"
            />
            <path
                fill="#f41936"
                d="M478.73,50.82c-11.81-10.33-24.96-17.38-39.46-21.14-14.49-3.76-31.87-5.64-52.14-5.64h-77.9c-12.88,0-22.21,2.89-27.98,8.66-5.77,5.77-8.66,15.1-8.66,27.98v74.24c14.78-23.94,34.01-39.62,38.72-43.27,9.15-9.17,21.17-15.64,34.94-17.83,29.23-4.64,56.96,11.46,68.2,37.41l50.47-8.01c7.23-1.25,13.15-1.4,18.01-.86,2.11-.81,4.43-1.27,6.88-1.27,9.42,0,18.97-.51,17.05,14.83-.25,1.99-.83,3.89-1.71,5.62,8,127.63-100.24,80.3-119.21,71.05-1.2.64-2.43,1.24-3.68,1.8-2.31,9.09-8.3,35.91-5.56,60.76,2.35,15.93,9.4,38.55,28.62,63.46,6.95-.43,13.48-1.12,19.55-2.11,10.8-1.74,20.9-4.76,30.3-9.06,9.39-4.29,18.05-10,25.97-17.11,10.07-9.26,18.32-19.76,24.76-31.5,6.44-11.74,11.2-24.93,14.29-39.56,3.09-14.63,4.63-30.8,4.63-48.51,0-53.68-15.37-93.67-46.1-119.98Z"
            />
            <path
                fill="#f41936"
                d="M398.58,117.34c2.17-.34,3.3-4.59,2.52-9.49-.78-4.9-3.17-8.59-5.34-8.24-2.17.34-3.3,4.6-2.52,9.49.78,4.9,3.17,8.59,5.34,8.24Z"
            />
        </g>
        <path
            fill={color}
            d="M24.49,53.47c0-13.85,10.91-28.95,28.53-28.95h96.92c54.54,0,103.64,36.5,103.64,106.57,0,66.29-49.09,103.22-103.64,103.22h-70.07v55.38c0,18.46-11.75,28.95-26.85,28.95-13.85,0-28.53-10.49-28.53-28.95V53.47Zm55.38,23.92v104.48h70.07c28.11,0,50.35-24.76,50.35-50.77,0-29.37-22.24-53.71-50.35-53.71h-70.07Z"
        />
        <path
            fill={color}
            d="M613.56,78.47h-73.76c-36.67,0-36.67-53.95,0-53.95h199.37c37.51,0,37.51,53.95,0,53.95h-69.97v212.86c0,36.67-55.64,37.52-55.64,0V78.47Z"
        />
    </svg>
)

export const SvgPerrito = ({ size = 100 }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
    ...
    >
        <path
            ...
            strokeMiterlimit="10"
            strokeWidth="4"
            d="m691.78,687.96s30.74-5.25,28.51-61.18c0,0,27.03,30.77,6.34,76.68-20.69,45.91-38.3,51.41-38.3,51.41l3.46-66.91Z"
        />
        <path
            fill="#ab0019"
            strokeWidth="0"
            d="m808.87,261.42c-35.24-22.68-40.27-30.18-64.05-133.39-21.96-95.31-114.46-58.95-128.47-52.84-22.54-12.81-48.58-20.16-76.35-20.16s-53.82,7.35-76.35,20.16c-14.01-6.11-106.51-42.48-128.47,52.84-23.77,103.2-28.81,110.71-64.05,133.39-35.24,22.67-57.65,131.76,73.12,130.07,100.43-1.29,89.59-55.03,79.15-79.9,28.38,32.49,70.08,53.05,116.61,53.05s88.23-20.56,116.61-53.05c-10.44,24.87-21.28,78.61,79.15,79.9,130.77,1.68,108.35-107.4,73.12-130.07Z"
        />
        <g>
            <path
                fill="#ab0019"
                ...
                strokeMiterlimit="10"
                strokeWidth="4"
                d="m310.94,880.01s3.06-15.02-25.99-54.02c-29.05-39-24.17-178.97,93.4-102.87l24.31,78.52-25.28,84.01-66.44-5.63Z"
            />
            <path
                fill="#ab0019"
                stroke="#fff"
                strokeMiterlimit="10"
                strokeWidth="4"
                d="m769.06,880.01s-3.06-15.02,25.99-54.02c29.05-39,24.17-178.97-93.4-102.87l-24.31,78.52,25.28,84.01,66.44-5.63Z"
            />
        </g>
        <path
            fill="#ab0019"
            ...
            strokeMiterlimit="10"
            strokeWidth="4"
            d="m693.72,692.99c-30.73-89.09-77.8-119.35-92.93-191.64l-60.79,8.33-60.79-8.33c-15.13,72.28-62.2,102.54-92.93,191.64-30.73,89.09-12,186.59-12,186.59,0,0,23.21,94.71,153.02,101.69,4.19.26,8.42.4,12.7.4,0,0,133.81,7.82,165.72-102.08,0,0,18.73-97.5-12-186.59Z"
        />
        <g>
            <path
                fill="#ab0019"
                ...
                strokeMiterlimit="10"
                strokeWidth="4"
                d="m417.05,993.1h-161.38v-41.67c0-44.56,36.13-80.69,80.69-80.69h0c44.56,0,80.69,36.13,80.69,80.69v41.67Z"
            />
            <path
                fill="#ab0019"
                stroke="#fff"
                strokeMiterlimit="10"
                strokeWidth="4"
                d="m824.33,993.1h-161.38v-41.67c0-44.56,36.13-80.69,80.69-80.69h0c44.56,0,80.69,36.13,80.69,80.69v41.67Z"
            />
        </g>
        <g>
            <path
                ...
                strokeMiterlimit="10"
                strokeWidth="4"
                d="m534.96,1024.96h-203.4v-52.52c0-56.17,45.53-101.7,101.7-101.7h0c56.17,0,101.7,45.53,101.7,101.7v52.52Z"
            />
            <path
                fill="#ab0019"
                stroke="#fff"
                strokeMiterlimit="10"
                strokeWidth="4"
                d="m748.45,1024.96h-203.4v-52.52c0-56.17,45.53-101.7,101.7-101.7h0c56.17,0,101.7,45.53,101.7,101.7v52.52Z"
            />
        </g>
        <path
            fill="#ab0019"
            ...
            strokeMiterlimit="10"
            strokeWidth="4"
            d="m331.92,328.24c0,11.94.93,23.65,2.73,35.06,16.14,102.6,101.94,180.91,205.36,180.91,114.92,0,208.08-96.69,208.08-215.96s-416.17-119.27-416.17,0Z"
        />
        <g>
            <path
                fill="none"
                ...
                strokeMiterlimit="10"
                strokeWidth="4"
                d="m389.91,171.36s-12.8,42.08,4.26,90.83"
            />
            <path
                fill="none"
                stroke="#fff"
                strokeMiterlimit="10"
                strokeWidth="4"
                d="m690.09,171.36s12.8,42.08-4.26,90.83"
            />
        </g>
        <g>
            <ellipse fill="#fff" cx="488.41" cy="194.07" rx="10.07" ry="22.71" />
            <ellipse fill="#fff" cx="591.59" cy="194.07" rx="10.07" ry="22.71" />
        </g>
        <path
            fill="#fff"
            d="m498.48,240.58c0-17.42,83.04-17.42,83.04,0s-18.59,31.55-41.52,31.55-41.52-14.12-41.52-31.55Z"
        />
        <g>
            <path
                fill="none"
                ...
                strokeMiterlimit="10"
                strokeWidth="4"
                d="m437.47,873.66s7.7-71.88-6.28-133.55c-13.98-61.67-11.75-51.39-11.75-51.39"
            />
            <path
                fill="none"
                stroke="#fff"
                strokeMiterlimit="10"
                strokeWidth="4"
                d="m492.42,889.85s-9.3-88.07,4.69-149.74c13.98-61.67,11.75-73.41,11.75-73.41"
            />
            <path
                fill="none"
                stroke="#fff"
                strokeMiterlimit="10"
                strokeWidth="4"
                d="m642.53,873.38s-7.7-71.13,6.28-132.8c13.98-61.67,11.75-51.39,11.75-51.39"
            />
            <path
                fill="none"
                stroke="#fff"
                strokeMiterlimit="10"
                strokeWidth="4"
                d="m587.58,889.67s9.3-87.42-4.69-149.09c-13.98-61.67-11.75-73.41-11.75-73.41"
            />
        </g>
    </svg>
);
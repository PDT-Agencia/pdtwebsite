...
const Footer = () => {
  return (
    <footer className='bg-black text-white  flex items-center justify-center z-40 relative'>
      <div className='max-w-[1440px] py-8 px-5 flex flex-col md:flex-row md:px-10 md:py-12 gap-5 md:gap-10'>
        ...
        <div className='flex flex-col gap-5'>
          <div className='flex flex-col gap-3'>
            ...
            <ul className='opacity-75 flex flex-col gap-5'>
              ...
              <li><Link href='/'>pdtcomunicaciones@gmail.com</Link></li>
            </ul>
        ...
        <div className='flex justify-center md:items-center md:flex-col gap-3'>

<x-app-layout>
    ...
    <div class="bg-black container-our-service">
        ...
        <div class="container">
            ...
            <div id='content-services'>
                @include('services.software-developer-service')
                @include('services.desing-service')
                @include('services.developer-apps-service')
                @include('services.audio-visual-service')
            </div>
    ...
    <script>
        function goToService(sectionId) {
            ...
            var serviceSectionsContainer = document.querySelectorAll('.container-services');
            serviceSectionsContainer.forEach(function(section) {
                section.classList.remove('active');
            });
            ...
            var selectedSectionService = document.getElementById(`service-${sectionId}`);
            selectedSectionService.classList.add('active');

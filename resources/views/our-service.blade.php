<x-app-layout>
    ...
    <div class="bg-black container-our-service">
        <br> <br>
        <div class="container">
            <div class="container-message-hero row mt-6">
                <div class="col-6">
                    <h3 class="container-message-hero-title text-white">
                        Nuestros Servicios
                    </h3>

                    <div class="container-message-hero-text">
                        <p class="text-white">
                ...
                <div class="container-dog-hero col-6">
                    <svg width="277" height="193" viewBox="0 0 277 193" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M276.321 28.1859L263.909 21.9798C256.152 18.8767 254.6 11.8949 254.6 11.8949C246.067 1.03433 234.43 1.03434 234.43 1.03434C220.467 -1.29293 209.606 1.03434 209.606 1.03434C199.521 -1.29293 199.521 1.81009 199.521 1.81009C190.212 0.258574 190.988 10.3434 190.988 10.3434C188.661 15.7737 195.642 13.4465 195.642 13.4465L197.97 15.7737L187.109 27.4101L225.897 50.6828H227.449C231.327 52.2343 233.655 49.9071 233.655 49.9071C235.982 53.0101 239.085 49.9071 239.085 49.9071L251.497 56.1131C266.236 60.7677 263.133 50.6828 263.133 50.6828C272.442 54.5616 253.049 39.0464 253.049 39.0464L266.236 39.8222C276.321 40.598 275.546 33.6161 275.546 33.6161C277.873 29.7374 276.321 28.1859 276.321 28.1859ZM243.739 17.3252C243.739 17.3252 249.17 11.1192 252.273 18.101C252.273 18.101 249.945 23.5313 243.739 17.3252Z" fill="#DE383F"/>
                        <path d="M210.23 95.131C210.23 95.131 204.024 101.337 217.212 109.095C217.212 109.095 240.485 119.955 228.848 135.47C228.848 135.47 220.315 159.519 199.37 154.864C199.37 154.864 194.715 144.779 207.903 140.901L216.436 130.04L182.303 115.301L188.509 132.367C188.509 132.367 190.836 147.882 178.424 147.882L143.515 152.537C143.515 152.537 138.861 133.919 162.909 138.573L170.667 137.022L159.03 118.404C159.03 118.404 105.503 112.198 99.297 108.319C99.297 108.319 96.1939 138.573 70.5939 148.658L65.1636 160.295C65.1636 160.295 68.2667 177.361 86.8848 179.689C86.8848 179.689 95.4182 184.343 96.1939 189.773H94.6424C94.6424 189.773 79.1273 195.979 68.2667 188.998L48.097 162.622C48.097 162.622 42.6667 154.089 48.8727 149.434C48.8727 149.434 62.0606 133.143 58.9576 122.282C58.9576 122.282 42.6667 95.131 48.097 81.1673V71.8582L23.2727 50.137C23.2727 50.137 6.20606 33.8461 0 31.5188C0 31.5188 16.2909 26.8643 38.7879 49.3613C38.7879 49.3613 48.097 60.2219 59.7333 59.4461C59.7333 59.4461 96.9697 41.6037 135.758 50.137C135.758 50.137 174.097 39.6036 179.527 34.1733H179.854L179.97 34.6023C180.528 34.6323 217.226 56.3567 217.988 57.1188C216.436 60.2219 216.436 65.6522 219.539 74.9613C219.539 74.9613 222.642 80.3916 210.23 95.131Z" fill="#DE383F"/>
                    </svg>
                </div>
            </div>

            <div class="container-banner">
                <div class="banner text-center row mx-5 d-flex justify-content-center align-items-center">
                    <div class="test-margin-select col-3" onclick="addSVG(event)">
                        <div class="test-container-svg">
                            <svg id="svg-1" xmlns="http://www.w3.org/2000/svg" width="62" height="47" viewBox="0 0 62 47"
                                fill="none">
                    ...
                    <div class="test-margin col-3" onclick="addSVG(event)">
                        <svg id="svg-2" xmlns="http://www.w3.org/2000/svg" width="47" height="47" viewBox="0 0 47 47"
                            fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div class="test-margin col-3" onclick="addSVG(event)">
                        <svg id="svg-3" xmlns="http://www.w3.org/2000/svg" width="47" height="47" viewBox="0 0 47 47"
                            fill="none">
                            <path
                    ...
                    <div class="test-margin col-3" onclick="addSVG(event)">
                        <svg id="svg-4" xmlns="http://www.w3.org/2000/svg" width="57" height="47" viewBox="0 0 57 47"
                            fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div class="row text-white serv container-services">
                <div class="col-4">
                ...
                <div class="container-service-separator"></div>
            ...
            <div class="container-own-services">
                <h3 class="container-message-hero-title text-white">
    ...
    <style>
        ...
        .service-image img {
            /* Establece el ancho de la imagen al 100% para que ocupe todo el ancho del contenedor */
            width: 100%;
    ...
    <script>
    // Variable para almacenar el contenedor seleccionado actualmente
    let selectedContainer = null;

    // Función para agregar el SVG al contenedor clicado
    function addSVG(event) {
        // Crear un nuevo elemento SVG
        const svgElement = document.createElementNS("http://www.w3.org/2000/svg", "svg");
        svgElement.setAttribute("width", "216");
        svgElement.setAttribute("height", "131");
        svgElement.setAttribute("viewBox", "0 0 216 131");

        // Crear el grupo y los elementos del SVG
        const groupElement = document.createElementNS("http://www.w3.org/2000/svg", "g");
        const pathElement = document.createElementNS("http://www.w3.org/2000/svg", "path");
        pathElement.setAttribute("d", "M215.708 23.3947C172.232 23.3947 191.279 130.843 108.26 130.843C25.2415 130.843 43.253 23.3947 0.812012 23.3947C0.812012 15.3202 108.26 0 108.26 0C108.26 0 215.708 11.8009 215.708 23.3947Z");
        pathElement.setAttribute("fill", "black");

        const ellipseElement = document.createElementNS("http://www.w3.org/2000/svg", "ellipse");
        ellipseElement.setAttribute("cx", "108.054");
        ellipseElement.setAttribute("cy", "58.3828");
        ellipseElement.setAttribute("rx", "52.5855");
        ellipseElement.setAttribute("ry", "52.5855");
        ellipseElement.setAttribute("fill", "white");

        // Agregar los elementos SVG al grupo
        ...
        // Obtener el contenedor clicado
        const container = event.currentTarget;

        // Si ya hay un contenedor seleccionado, quitar la clase 'test-margin-select' y limpiar el contenido
        if (selectedContainer) {
            selectedContainer.classList.remove('test-margin-select');
            selectedContainer.style.transform = 'translateX(0)';
            selectedContainer.innerHTML = '';
        }

        // Agregar el SVG al contenedor clicado
        container.appendChild(svgElement);

        // Agregar la clase 'test-margin-select' al contenedor clicado
        container.classList.add('test-margin-select');

        // Calcular la dirección del desplazamiento
        const direction = event.clientX > container.getBoundingClientRect().left ? 'right' : 'left';

        // Aplicar el desplazamiento con una transición suave
        container.style.transform = `translateX(${direction === 'right' ? '0px' : '0px'})`;

        // Establecer el contenedor actual como seleccionado
        selectedContainer = container;

        // Reiniciar el desplazamiento después de que se complete la transición
        setTimeout(() => {
            container.style.transform = 'translateX(0)';
        }, 300);
    }

    // Establecer la primera opción como seleccionada por defecto al cargar la página
    window.onload = function () {
        const defaultContainer = document.querySelector(".col-3");
        addSVG({ currentTarget: defaultContainer });
    };
</script>

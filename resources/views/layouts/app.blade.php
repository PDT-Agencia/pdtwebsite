...
<body class="">
    ...
    <style>
        .service {
            border-radius: 30px;
            border: 1px solid var(--Gris-PDT, #D9D9D9);
        ...
        @keyframes slide-up {
            0% {
                ...
                /* Comienza debajo de la pantalla */
            }
        ...
        .circle-pdt svg {
            position: absolute;
            /* Establece la posición absoluta para el SVG */
            top: 50%;
            /* Centra verticalmente */
            left: 50%;
            /* Centra horizontalmente */
            transform: translate(-50%, -50%);
            /* Centra el SVG correctamente */
        }
        ...
        .background-container {
            position: relative;
            background: linear-gradient(180deg, rgba(0, 0, 0, 0.00) 0%, #000 100%), url('{{ asset('image/' . $image) }}');
